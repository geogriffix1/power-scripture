...
//    }
//    if (match && match.length > 3) {
//        obj.startVerse = match[3];
//    }
//    if (match && match.length > 4) {
//        obj.endVerse = match[4];
//    }

//    var errorText = "";
//    var book = null;
//    if (!obj.book) {
//        errorText = `Invalid Bible book name, ${citation}`;
//        return errorText;
...
//            obj.chapter = 1;
//        } else {
//            errorText = "Chapter number is missing";
//            validation.error = errorMessage(statusValue, errorValue, pathValue, errorText, infoValue);
//            return validation;
//        }
//    } else {
//        if (eval(obj.chapter) > book.chapterCount) {
//            errorText = `Invalid Chapter, last chapter is ${book.chapterCount}`;
//            validation.error = errorMessage(statusValue, errorValue, pathValue, errorText, infoValue);
//            return validation;
//        }
//    }
...
//    if (!obj.startVerse) {
//        errorText = "Verse number is missing";
//        validation.error = errorMessage(statusValue, errorValue, pathValue, errorText, infoValue);
//        return validation;
//    } else { }  // Check start verse number is not too big

//    if (obj.endVerse) {
//        if (obj.endVerse < obj.startVerse) {
//            errorText = "Invalid end verse number";
//            validation.error = errorMessage(statusValue, errorValue, pathValue, errorText, infoValue);
//            return validation;
//        } else { } // Check end verse number is not too big
//    } else {
//        obj.endVerse = obj.startVerse;
//    }
