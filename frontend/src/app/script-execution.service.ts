...
// type PendingOp =
//   | { kind: "CreateTheme"; parentId: number; name: string; description?: string | null; sequence: number; tempId: number }
...
//           pending.push({ kind: "CreateTheme", parentId: parent, name, sequence, tempId: id });
